            ...
            <div className="flex gap-10 md:gap-16">
              {statsData.map((stat) => (
                <div key={stat.label} className="flex flex-col items-start">
                  ...
                  {/* Render the rating stars only for the rating stat */}
                  {stat.icon && <StarRating rating={4.88} />}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:w-1/2 flex flex-col justify-between p-6 bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-100">
              ...
              <div className="flex gap-3">
                <button className="p-3 rounded-full border border-gray-300 text-gray-600 hover:bg-gray-100 transition disabled:opacity-50" aria-label="Previous testimonial">
                  <FaArrowLeft className="w-4 h-4" />
                </button>
                <button className="p-3 rounded-full bg-indigo-600 text-white hover:bg-indigo-700 transition" aria-label="Next testimonial">
