...
const RecentActivity = ({ property }) => {
  const { name, address, regularPrice, bedrooms, bathrooms, type } =
    property;
  ...
  return (
    ...
    <div
      className="flex bg-white rounded-xl shadow-xl overflow-hidden 
    ...
    >
      ...
      <div className="flex-shrink-0 w-24 h-24 relative">
        ...
        <span
          className={`absolute bottom-0 left-0 text-xs font-bold text-white px-1 py-0.5 uppercase ${
            type === "rent" ? "bg-indigo-600" : "bg-green-600"
          }`}
        >
          {type === "rent" ? "Rent" : "Sale"}
        </span>
      ...
      <div className="flex flex-col justify-center p-3 flex-grow">
        ...
        {/* Price and Location */}
        <p className="text-sm font-extrabold text-[#1F4B43]">
          {formattedPrice}
        </p>
